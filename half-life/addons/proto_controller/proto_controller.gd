...
## Name of Input Action to look Left.
@export var look_left : String = "look_left"
## Name of Input Action to look Right.
@export var look_right : String = "look_right"
## Name of Input Action to look Up.
@export var look_up : String = "look_up"
## Name of Input Action to look Down.
